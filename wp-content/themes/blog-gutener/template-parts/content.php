...
<?php
	$stickyClass = '';
	$layout_class = '';
	if( get_theme_mod( 'sidebar_settings', 'no-sidebar' ) == 'right' ) {
	...
	}elseif( get_theme_mod( 'sidebar_settings', 'no-sidebar' ) == 'left' ) {
		if ( get_theme_mod( 'archive_post_layout', 'grid' ) == 'grid' ){
			$stickyClass = "col-sm-6 grid-post";
		}elseif ( get_theme_mod( 'archive_post_layout', 'grid' ) == 'list' ) {
			$stickyClass = "col-12";
	...
	}elseif( get_theme_mod( 'sidebar_settings', 'no-sidebar' ) == 'no-sidebar' ) {
		if ( get_theme_mod( 'archive_post_layout', 'grid' ) == 'grid' ){
	...
	}elseif( get_theme_mod( 'sidebar_settings', 'no-sidebar' ) == 'right-left' ) {
		if ( get_theme_mod( 'archive_post_layout', 'grid' ) == 'grid' ){
